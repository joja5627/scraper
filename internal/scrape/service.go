...
import (
	...
	"github.com/joja5627/scraper/internal/async"
)
...
func NewScrapeService(repo Repo) ScrapeService {
	return &scrapeService{
		repo,
	}
}

func (s *scrapeService) ScrapeCL(urls []string) []string {
	var links []string
