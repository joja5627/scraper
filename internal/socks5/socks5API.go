...
var LISTEN string = "localhost:1080" // listen address, e.g. 0.0.0.0:1080
var sock5KILL = make(chan bool, 1)
...
func handleConnection(frontconn net.Conn,shutdown chan bool) {
...
func ListenAndServe() {
	...
	for {
		...
		go handleConnection(conn,sock5KILL)
	}
}
